              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-gray-200">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Connect your Gmail account to send meeting invitations and agendas directly from your email.
                  </p>
                  <button
                    onClick={() => {
                      window.location.href = '/api/auth/gmail/authorize';
                    }}
                    className="w-full px-6 py-3 bg-green-100 text-green-700 rounded-xl hover:bg-green-200 transition-colors font-medium flex items-center justify-center gap-2 shadow-sm"
                  >
